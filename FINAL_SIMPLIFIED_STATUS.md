...
- **السبب**: تضارب في أسماء الشاشات بين LoginScreen والـ Navigator
- **الحل**: تصحيح أسماء الشاشات + إضافة حالة restoring
- **النتيجة**: تنقل سلس + تجربة مستخدم محسنة
...
1. **`App.js`** - إصلاح شامل + تبسيط التنقل + استخدام حالة restoring
2. **`context/AuthContext.js`** - تحسين إدارة الجلسة + إضافة حالة restoring
3. **`screens/SplashScreen.js`** - شاشة تحميل محسنة
4. **`screens/LoginScreen.js`** - تصحيح أسماء الشاشات + إضافة fallback
